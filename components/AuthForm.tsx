  ...
  if (sent) {
    return (
      <div className="rounded-xl border border-black/10 dark:border-white/10 p-6">
        ...
        <p className="opacity-80 text-sm mt-1">We sent a magic link to <strong>{email}</strong>.</p>
        <p className="opacity-70 text-xs mt-2">Only <strong>admin@rentback.app</strong> is allowed.</p>
      </div>
    );
  }
    ...
    <form onSubmit={onSubmit} className="rounded-xl border border-black/10 dark:border-white/10 p-6 space-y-4">
      <div>
        ...
        <input
          ...
          placeholder="admin@rentback.app"
      ...
      <p className="opacity-70 text-xs">Only <strong>admin@rentback.app</strong> will be admitted.</p>
    </form>
  );
}
